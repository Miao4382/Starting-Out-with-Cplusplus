...
private:
  ...
  // if match found, return a pointer pointing to the val (private member of the TreeNode that hold data)
  // if no match found, return nullptr
  T* search(TreeNode<T>* node_ptr, T val);
...
public:
  ...
  // return a pointer that points to val (the private member of TreeNode that hold the data for the node) if found 
...
// it will find out if there is a match for value in branch pointed by the pointer 
template <class T>
T* BinarySearchTree<T>::search(TreeNode<T>* node_ptr, T val)
{
...
// accepts a T variable
// Search the binary tree to find out if there is a node containing this the value of this T variable 
// if found: return the address of the value (private member that hold data stored in each node)
// if not found: return nullptr 
template <class T>
T* BinarySearchTree<T>::Search(T val)
{
